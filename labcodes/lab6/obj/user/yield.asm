...
00800098 <sys_yield>:
  800098:	00a00513          	li	a0,10
  80009c:	f85ff06f          	j	800020 <syscall>

008000a0 <sys_getpid>:
  8000a0:	01200513          	li	a0,18
  8000a4:	f7dff06f          	j	800020 <syscall>

008000a8 <sys_putc>:
  8000a8:	00050593          	mv	a1,a0
  8000ac:	01e00513          	li	a0,30
...
008000b4 <exit>:
  ...
  8000c4:	78050513          	addi	a0,a0,1920 # 800840 <main+0x94>
  8000c8:	048000ef          	jal	ra,800110 <cprintf>
  8000cc:	0000006f          	j	8000cc <exit+0x18>

008000d0 <yield>:
  8000d0:	fc9ff06f          	j	800098 <sys_yield>

008000d4 <getpid>:
  8000d4:	fcdff06f          	j	8000a0 <sys_getpid>
...
008001b8 <printnum>:
  ...
  800208:	00001797          	auipc	a5,0x1
  80020c:	80878793          	addi	a5,a5,-2040 # 800a10 <error_string+0x64>
...
00800260 <vprintfmt>:
  ...
  8002ac:	5aca0a13          	addi	s4,s4,1452 # 800854 <main+0xa8>
  ...
  800440:	57070713          	addi	a4,a4,1392 # 8009ac <error_string>
  ...
  800454:	68c60613          	addi	a2,a2,1676 # 800adc <error_string+0x130>
  ...
  8006f0:	3e460613          	addi	a2,a2,996 # 800ad0 <error_string+0x124>
  ...
  800730:	39c40413          	addi	s0,s0,924 # 800ac8 <error_string+0x11c>
  800734:	daf818e3          	bne	a6,a5,8004e4 <vprintfmt+0x284>
  800738:	00000a97          	auipc	s5,0x0
  80073c:	391a8a93          	addi	s5,s5,913 # 800ac9 <error_string+0x11d>
  ...
  800768:	365a8a93          	addi	s5,s5,869 # 800ac9 <error_string+0x11d>
...
008007ac <main>:
  ...
  8007b4:	00812423          	sw	s0,8(sp)
  8007b8:	00912223          	sw	s1,4(sp)
  8007bc:	01212023          	sw	s2,0(sp)
  8007c0:	915ff0ef          	jal	ra,8000d4 <getpid>
  8007c4:	00050593          	mv	a1,a0
  8007c8:	00000517          	auipc	a0,0x0
  8007cc:	31850513          	addi	a0,a0,792 # 800ae0 <error_string+0x134>
  8007d0:	941ff0ef          	jal	ra,800110 <cprintf>
  8007d4:	00000413          	li	s0,0
  8007d8:	00000917          	auipc	s2,0x0
  8007dc:	32490913          	addi	s2,s2,804 # 800afc <error_string+0x150>
  8007e0:	00500493          	li	s1,5
  8007e4:	8edff0ef          	jal	ra,8000d0 <yield>
  8007e8:	8edff0ef          	jal	ra,8000d4 <getpid>
  8007ec:	00040613          	mv	a2,s0
  8007f0:	00050593          	mv	a1,a0
  8007f4:	00140413          	addi	s0,s0,1
  8007f8:	00090513          	mv	a0,s2
  8007fc:	915ff0ef          	jal	ra,800110 <cprintf>
  800800:	fe9412e3          	bne	s0,s1,8007e4 <main+0x38>
  800804:	8d1ff0ef          	jal	ra,8000d4 <getpid>
  800808:	00050593          	mv	a1,a0
  80080c:	00000517          	auipc	a0,0x0
  800810:	31450513          	addi	a0,a0,788 # 800b20 <error_string+0x174>
  800814:	8fdff0ef          	jal	ra,800110 <cprintf>
  800818:	00000517          	auipc	a0,0x0
  80081c:	32450513          	addi	a0,a0,804 # 800b3c <error_string+0x190>
  800820:	8f1ff0ef          	jal	ra,800110 <cprintf>
  800824:	00c12083          	lw	ra,12(sp)
  800828:	00000513          	li	a0,0
  80082c:	00812403          	lw	s0,8(sp)
  800830:	00412483          	lw	s1,4(sp)
  800834:	00012903          	lw	s2,0(sp)
  800838:	01010113          	addi	sp,sp,16
  80083c:	00008067          	ret
