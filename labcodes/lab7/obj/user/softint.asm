...
008000a4 <exit>:
  ...
  8000b4:	6f450513          	addi	a0,a0,1780 # 8007a4 <main+0x10>
...
008001a0 <printnum>:
  ...
  8001f4:	78478793          	addi	a5,a5,1924 # 800974 <error_string+0x64>
...
00800248 <vprintfmt>:
  ...
  800294:	528a0a13          	addi	s4,s4,1320 # 8007b8 <main+0x24>
  ...
  800428:	4ec70713          	addi	a4,a4,1260 # 800910 <error_string>
  ...
  80043c:	60860613          	addi	a2,a2,1544 # 800a40 <error_string+0x130>
  ...
  8006d8:	36060613          	addi	a2,a2,864 # 800a34 <error_string+0x124>
  ...
  800718:	31840413          	addi	s0,s0,792 # 800a2c <error_string+0x11c>
  80071c:	daf818e3          	bne	a6,a5,8004cc <vprintfmt+0x284>
  800720:	00000a97          	auipc	s5,0x0
  800724:	30da8a93          	addi	s5,s5,781 # 800a2d <error_string+0x11d>
  ...
  800750:	2e1a8a93          	addi	s5,s5,737 # 800a2d <error_string+0x11d>
...
00800794 <main>:
  800794:	ff010113          	addi	sp,sp,-16
  800798:	00000513          	li	a0,0
  80079c:	00112623          	sw	ra,12(sp)
  8007a0:	905ff0ef          	jal	ra,8000a4 <exit>
