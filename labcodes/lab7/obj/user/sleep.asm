...
00800020 <__panic>:
  ...
  800040:	90450513          	addi	a0,a0,-1788 # 800940 <main+0x88>
  ...
  800070:	8f050513          	addi	a0,a0,-1808 # 80095c <main+0xa4>
...
0080011c <sys_gettime>:
  80011c:	01100513          	li	a0,17
...
00800130 <exit>:
  ...
  800140:	82450513          	addi	a0,a0,-2012 # 800960 <main+0xa8>
...
00800154 <gettime_msec>:
  800154:	fc9ff06f          	j	80011c <sys_gettime>

00800158 <sleep>:
  800158:	fcdff06f          	j	800124 <sys_sleep>
...
00800164 <cputch>:
  ...
  800174:	f9dff0ef          	jal	ra,800110 <sys_putc>
...
00800220 <umain>:
  ...
  800228:	690000ef          	jal	ra,8008b8 <main>
...
00800270 <printnum>:
  ...
  8002c4:	87078793          	addi	a5,a5,-1936 # 800b30 <error_string+0x64>
...
00800318 <vprintfmt>:
  ...
  800364:	614a0a13          	addi	s4,s4,1556 # 800974 <main+0xbc>
  ...
  8004f8:	5d870713          	addi	a4,a4,1496 # 800acc <error_string>
  ...
  80050c:	6f460613          	addi	a2,a2,1780 # 800bfc <error_string+0x130>
  ...
  8007a8:	44c60613          	addi	a2,a2,1100 # 800bf0 <error_string+0x124>
  ...
  8007e8:	40440413          	addi	s0,s0,1028 # 800be8 <error_string+0x11c>
  8007ec:	daf818e3          	bne	a6,a5,80059c <vprintfmt+0x284>
  8007f0:	00000a97          	auipc	s5,0x0
  8007f4:	3f9a8a93          	addi	s5,s5,1017 # 800be9 <error_string+0x11d>
  ...
  800820:	3cda8a93          	addi	s5,s5,973 # 800be9 <error_string+0x11d>
...
00800864 <sleepy>:
  800864:	fe010113          	addi	sp,sp,-32
  800868:	00812c23          	sw	s0,24(sp)
  80086c:	00912a23          	sw	s1,20(sp)
  800870:	01212823          	sw	s2,16(sp)
  800874:	01312623          	sw	s3,12(sp)
  800878:	00112e23          	sw	ra,28(sp)
  80087c:	00000413          	li	s0,0
  800880:	06400493          	li	s1,100
  800884:	00000997          	auipc	s3,0x0
  800888:	3fc98993          	addi	s3,s3,1020 # 800c80 <error_string+0x1b4>
  80088c:	00a00913          	li	s2,10
  800890:	00048513          	mv	a0,s1
  800894:	8c5ff0ef          	jal	ra,800158 <sleep>
  800898:	00140413          	addi	s0,s0,1
  80089c:	00048613          	mv	a2,s1
  8008a0:	00040593          	mv	a1,s0
  8008a4:	00098513          	mv	a0,s3
  8008a8:	921ff0ef          	jal	ra,8001c8 <cprintf>
  8008ac:	ff2412e3          	bne	s0,s2,800890 <sleepy+0x2c>
  8008b0:	00000513          	li	a0,0
  8008b4:	87dff0ef          	jal	ra,800130 <exit>

008008b8 <main>:
  8008b8:	fe010113          	addi	sp,sp,-32
  8008bc:	00812c23          	sw	s0,24(sp)
  8008c0:	00112e23          	sw	ra,28(sp)
  8008c4:	891ff0ef          	jal	ra,800154 <gettime_msec>
  8008c8:	00050413          	mv	s0,a0
  8008cc:	881ff0ef          	jal	ra,80014c <fork>
  8008d0:	06050663          	beqz	a0,80093c <main+0x84>
  8008d4:	00c10593          	addi	a1,sp,12
  8008d8:	879ff0ef          	jal	ra,800150 <waitpid>
  8008dc:	04051063          	bnez	a0,80091c <main+0x64>
  8008e0:	00c12783          	lw	a5,12(sp)
  8008e4:	02079c63          	bnez	a5,80091c <main+0x64>
  8008e8:	86dff0ef          	jal	ra,800154 <gettime_msec>
  8008ec:	408505b3          	sub	a1,a0,s0
  8008f0:	00000517          	auipc	a0,0x0
  8008f4:	36c50513          	addi	a0,a0,876 # 800c5c <error_string+0x190>
  8008f8:	8d1ff0ef          	jal	ra,8001c8 <cprintf>
  8008fc:	00000517          	auipc	a0,0x0
  800900:	37450513          	addi	a0,a0,884 # 800c70 <error_string+0x1a4>
  800904:	8c5ff0ef          	jal	ra,8001c8 <cprintf>
  800908:	01c12083          	lw	ra,28(sp)
  80090c:	00000513          	li	a0,0
  800910:	01812403          	lw	s0,24(sp)
  800914:	02010113          	addi	sp,sp,32
  800918:	00008067          	ret
  80091c:	00000697          	auipc	a3,0x0
  800920:	2e468693          	addi	a3,a3,740 # 800c00 <error_string+0x134>
  800924:	00000617          	auipc	a2,0x0
  800928:	31060613          	addi	a2,a2,784 # 800c34 <error_string+0x168>
  80092c:	01700593          	li	a1,23
  800930:	00000517          	auipc	a0,0x0
  800934:	31c50513          	addi	a0,a0,796 # 800c4c <error_string+0x180>
  800938:	ee8ff0ef          	jal	ra,800020 <__panic>
  80093c:	f29ff0ef          	jal	ra,800864 <sleepy>
